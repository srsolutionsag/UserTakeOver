...
```php
//...
use srag\ActiveRecordConfig\UserTakeOver\ActiveRecordConfigGUI;
//...
...
namespace srag\Plugins\X\Config
//...
use srag\ActiveRecordConfig\UserTakeOver\ActiveRecordConfigFormGUI;
//...
...
namespace srag\Plugins\X\Config
//...
use srag\ActiveRecordConfig\UserTakeOver\ActiveRecordConfigTableGUI;
//...
...
if (\srag\DIC\UserTakeOver\DICStatic::dic()->database()->tableExists(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME)) {
    ...
    \srag\DIC\UserTakeOver\DICStatic::dic()->database()->dropTable(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME);
}
?>
```
