...
final class ilUserTakeOverARConfig extends ActiveRecord
{
     ...
     */
    const TABLE_NAME = ilUserTakeOverPlugin::PLUGIN_ID . '_config';
     ...
     */
    const CNF_ID_GLOBAL_ROLES = 'cnf_global_role_ids';
     ...
     * @throws arException
     */
    private function validateIdentifier(string $identifier)
    {
