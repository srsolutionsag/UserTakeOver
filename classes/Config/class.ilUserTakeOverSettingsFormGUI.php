...
class ilUserTakeOverSettingsFormGUI extends ilPropertyFormGUI
{
     ...
     * lang vars
     */
    const CMD_TRANSLATION_SAVE     = 'save';
    const CMD_TRANSLATION_CANCEL   = 'cancel';
     ...
     * @return array
     */
    private function getAvailableGlobalRoles()
    {
        $roles = [];
        foreach (self::dic()->rbacreview()->getRolesByFilter(ilRbacReview::FILTER_ALL_GLOBAL) as $role_data) {
     ...
     * @throws arException
     */
    private function storeConfig(string $identifier, $value)
    {
